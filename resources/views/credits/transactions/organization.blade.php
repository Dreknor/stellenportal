@props(['organization', 'transactions', 'balance'])
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="space-x-2">
                            <a href="{{ route('credits.organization.transfer', $organization) }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg transition">
                                Guthaben umbuchen
                            </a>
                            <a href="{{ route('credits.organization.purchase', $organization) }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition">
                                Guthaben aufladen
                            </a>
                        </div>
                    </div>
