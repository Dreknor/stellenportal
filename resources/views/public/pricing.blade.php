                ...
                <div class="mb-16">
                    <div class="text-center mb-12">
                        <div class="inline-flex items-center bg-gradient-to-r from-purple-100 to-purple-200 rounded-full px-6 py-2 mb-4">
                            ...
                            <span class="font-bold text-purple-900">Exklusiv für Genossenschaftsmitglieder</span>
                        </div>
                        <h2 class="text-3xl font-bold text-gray-900 mb-3">Genossenschafts-Pakete</h2>
                        <p class="text-lg text-gray-600">Besondere Konditionen für Mitglieder unserer Genossenschaft</p>
                    </div>
