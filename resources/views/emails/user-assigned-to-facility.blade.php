...
<head>
    ...
    <title>Einrichtung zugewiesen</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #f4f4f4; padding: 20px; border-radius: 5px;">
        <h2 style="color: #2c3e50; margin-top: 0;">Neue Einrichtungszuweisung</h2>

        <p>Hallo {{ $user->first_name }} {{ $user->last_name }},</p>

        <p>Sie wurden der Einrichtung <strong>{{ $facility->name }}</strong> zugewiesen.</p>
        ...
        <p>Sie können sich nun mit Ihren bestehenden Zugangsdaten anmelden und auf die Funktionen dieser Einrichtung zugreifen.</p>
