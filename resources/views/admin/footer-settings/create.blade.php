<x-layouts.app>
    ...
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">{{ __('Neue Footer-Einstellung erstellen') }}</h1>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.footer-settings.store') }}" enctype="multipart/form-data" x-data="footerForm()">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea name="content" id="content" rows="5"
                          class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                          placeholder="{{ __('z.B. Copyright-Text, Adresse, etc.') }}">{{ old('content') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" id="background_color_picker" value="{{ old('background_color', '#ffffff') }}"
                            ...
                            <input type="text" name="background_color" id="background_color" value="{{ old('background_color', '#ffffff') }}" style="display:none;">
                            <input type="text" id="background_color_text" value="{{ old('background_color', '#ffffff') }}"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" id="text_color_picker" value="{{ old('text_color', '#6b7280') }}"
                                   class="h-10 w-20 rounded border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   oninput="document.getElementById('text_color').value = this.value; document.getElementById('text_color_text').value = this.value;">
                            <input type="text" name="text_color" id="text_color" value="{{ old('text_color', '#6b7280') }}" style="display:none;">
                            <input type="text" id="text_color_text" value="{{ old('text_color', '#6b7280') }}"
                                   class="flex-1 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="#6b7280"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" id="link_color_picker" value="{{ old('link_color', '#2563eb') }}"
                                   class="h-10 w-20 rounded border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   oninput="document.getElementById('link_color').value = this.value; document.getElementById('link_color_text').value = this.value;">
                            <input type="text" name="link_color" id="link_color" value="{{ old('link_color', '#2563eb') }}" style="display:none;">
                            <input type="text" id="link_color_text" value="{{ old('link_color', '#2563eb') }}"
                                   class="flex-1 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                   placeholder="#2563eb"
