...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This email address will receive invoice notifications when credits
    | are purchased. This should be the email of the person/department
    | responsible for creating invoices.
    |
    */

    'invoice_email' => env('MAIL_INVOICE_ADDRESS', env('MAIL_FROM_ADDRESS', 'hello@example.com')),
